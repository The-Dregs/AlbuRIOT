...
public class InventoryUI : MonoBehaviour
{
    ...
    public void RefreshUI()
    {
        ...
        for (int i = 0; i < loop; i++)
        {
            ...
            // don't display the currently equipped item in the inventory grid
            if (slot != null && slot.item != null && equipmentManager != null && equipmentManager.equippedItem == slot.item)
            {
                ui.Clear();
    ...
    // central equip handler so slots don't need direct access to private fields
