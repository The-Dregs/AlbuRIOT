...
public class GameManager : MonoBehaviourPun
{
    ...
    public void SetGameState(GameState newState)
    {
        ...
        {
            photonView.RPC("RPC_SetGameState", RpcTarget.Others, (int)newState);
        }
    }
    ...
    public void AddScore(int points)
    {
        ...
        if (photonView != null && photonView.IsMine)
        {
            photonView.RPC("RPC_AddScore", RpcTarget.Others, points);
        }
    }
    ...
    private void OnPlayerJoined(Photon.Realtime.Player player)
    {
        ...
        if (networkManager != null && networkManager.IsMasterClient())
        {
            photonView.RPC("RPC_SyncGameState", RpcTarget.Others, (int)currentGameState, score, gameTime);
        }
    }
