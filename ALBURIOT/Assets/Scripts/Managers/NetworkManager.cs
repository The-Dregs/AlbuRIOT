...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    private void SyncGameState()
    {
        ...
        if (questManager != null)
        {
            photonView.RPC("RPC_SyncQuestState", RpcTarget.Others, questManager.currentQuestIndex);
        }
        ...
        if (movesetManager != null)
        {
            ...
            photonView.RPC("RPC_SyncMovesetState", RpcTarget.Others, movesetName);
        }
    }
    ...
    public void SendChatMessage(string message)
    {
        ...
        photonView.RPC("RPC_ChatMessage", RpcTarget.All, formattedMessage);
    }
    ...
    public void SyncItemPickup(string itemName, int quantity)
    {
        ...
        photonView.RPC("RPC_SyncItemPickup", RpcTarget.Others, itemName, quantity);
    }
    ...
    public void SyncQuestProgress(int questIndex, int objectiveIndex, int progress)
    {
        ...
        photonView.RPC("RPC_SyncQuestProgress", RpcTarget.Others, questIndex, objectiveIndex, progress);
    }
