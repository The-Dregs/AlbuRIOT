...
public class CutsceneManager : MonoBehaviourPunCallbacks
{
    ...
    public override void OnJoinedRoom()
    {
        ...
        if (cutsceneMode == CutsceneMode.StartScene && TransitionControlledStart && !startSequenceStarted)
        {
            return;
        }
    ...
    private IEnumerator WaitForPlayerAndSetup()
    {
        ...
        if (player != null)
        {
            ...
            if (PlayerSpawnCoordinator.TryGetBestSpawnPosition(out Vector3 spawnPosition, out Vector3 faceDirection, out string source, requireSpawnMarkers: false))
            {
